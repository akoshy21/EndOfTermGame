...
public class InitScript : MonoBehaviour {
	...
	void MakeCharacters()
	{
		...
		characters [1].moveSet [2] = new Move ("Soft_Reset()", "blah blah", 1, false, 0, 3, false, characters[1], 2, true);
		characters [1].moveSet [3] = new Move ("Upgrade()", "blah blah", 2, false, 0, 6, false, characters[1], 3, true);
		...
		characters [2].moveSet [2] = new Move ("Soft_Reset()", "blah blah", 1, false, 0, 3, false, characters[2], 2, true);
		characters [2].moveSet [3] = new Move ("Upgrade()", "blah blah", 2, false, 0, 6, false, characters[2], 3, true);
		...
		characters [3].moveSet [2] = new Move ("Soft_Reset()", "blah blah", 1, false, 0, 3, false, characters[3], 1, true);
		characters [3].moveSet [3] = new Move ("Upgrade()", "blah blah", 2, false, 0, 6, false, characters[3], 2, true);
