...
public class InitScript : MonoBehaviour {
	...
	void MakeCharacters()
	{
		...
		characters [0].moveSet [1] = new Move ("Restore()", "blah blah", 1, false, 30, 4, false, characters [0]);
		...
		characters [1].moveSet [2] = new Move ("Sheild", "blah blah", 0, false, 0, 4, false, characters[1], 4, true);
